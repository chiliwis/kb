...
function Menu() {
  return (
    <>
      <div className="w3-container w3-padding-64" id="menu">
        <div className="w3-content" style={{ maxWidth: 700 }}>
          ...
          <div className="w3-row w3-center w3-card w3-padding w3-orange">
            ...
            <a href="javascript:void(0)" onclick="openMenu(event, 'Drinks');">
              <div className="w3-col s6 tablink w3-orange">
                Pedidos Especiales
              </div>
            </a>
          </div>
          ...
          >
            <h5>Pan de muerto</h5>
            <p className="w3-text-grey">
              Relleno de frutos rojos y crema de nata $
            </p>
            <br />
            <h5>Rosca de reyes</h5>
            <p className="w3-text-grey">
              Tradicional, rellena de crema de avellana o zarzamora con queso
              crema $
            </p>
            <br />
            <h5>Galletas de cafe</h5>
            <p className="w3-text-grey">Para acompañar tu despertar $</p>
            <br />
            <h5>Besos de nuez</h5>
            <p className="w3-text-grey">Receta de la abuela $</p>
            <br />
